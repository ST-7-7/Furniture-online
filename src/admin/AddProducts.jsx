          ...
          <Col lg='12'>
            ...
            <Form onSubmit={addProduct}>
              ...
              <FormGroup className='form-group'>
                ...
                <input type="text" placeholder='lorem...' value={enterShortDecs}
                  onChange={ e => setEnterShortDecs(e.target.value)} required />
              </FormGroup>
              ...
              <button className='buy-button' type='submit'>Add Product</button>
            </Form>
              </>)
            }
